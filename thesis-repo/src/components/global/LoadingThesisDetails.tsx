...
const LoadingThesisDetails: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <h2 className="text-xl font-semibold mt-4 text-purple-800">Loading artificats...</h2>
      <p className="text-sm text-gray-500 mt-2">Please wait while we prepare your thesis</p>
    </div>
  );
};

export default LoadingThesisDetails;